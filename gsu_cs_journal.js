 ...
 */
  ...
  /*
	...
	Module			: Journal Entry (Client Script)
 */
    ...
    function sublistChanged(context) {
		...
		if (lineCount > 0){
			for (var i = 0; i < lineCount; i++){
				...
				debittotal += debit;
				//alert('nilai Debit : '+debittotal);
			}
			rec.setValue('custbody_gsu_nilai_journal', debittotal);
			
			var lokasi			= rec.getSublistValue({
				sublistId 	: 'line',
				fieldId		: 'location',
				line		: 0
			});
			rec.setValue('custbody_gsu_lokasi_transaksi', lokasi);
		}
    }
