 ...
 */
  ...
  /*
	...
	Company			: Gading Semesta Utama
	Date			: June, 12, 2019
	Module			: Sales Order (Client Script)
	
	Revisi untuk client script berkaitan dengan Terbilang
 */
...
function(record, currentRecord, runtime) {
    ...
    function sublistChanged(context) {
		...
		if(lineCount > 0){
			...
			totalInvoice = rec.getValue('total');
			
			// rec.setValue('total', totalInvoice);
			rec.setValue('custbody_gsu_cp_terbilang', terbilang(Math.round(totalInvoice)));
		}
    }
